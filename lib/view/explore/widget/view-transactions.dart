...
import 'package:smart_web/view/explore/helpers/dialog-box.dart';

import '../../../apis/api-service.dart';
import '../../../utils/utils.dart';

class ViewTxns extends StatefulWidget {
  const ViewTxns({super.key});

  @override
  State<ViewTxns> createState() => _ViewTxnsState();
}

final TextEditingController searchController = TextEditingController();

class _ViewTxnsState extends State<ViewTxns> {
  int _currentPage = 1;
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        // Search Section
          ...
          child: isMobile
              ...
              children: [
                ...
                SizedBox(height: isMobile ? 12.h : 50.h),
        ...
        Padding(
            ...
            width: double.infinity,
              ...
              padding: EdgeInsets.all(isMobile ? 16.w : 20.w),
                ...
                mainAxisSize: MainAxisSize.min,
                  children: [
                          SizedBox(height: isMobile ? 12.h : 60.h),
                              ...
                              return SizedBox(
                                ...
                                child: isMobile
                                    ...
                                    : ListView.builder(
                                        ...
                                        itemBuilder: (context, index) {
                                          final transaction = transactions[index];
                                          return _buildDesktopTransactionRow(transaction, index);
                                        },
                                      ),
                              );
                    },
                  ...
                  NumberPaginator(
                    showNextButton: true,
                    showPrevButton: true,
                    numberPages: (transactions.length / _itemsPerPage).ceil() > 0
          ...
          Widget _buildMobileTransactionCard(Map<String, dynamic> transaction, int index) {
            return Container(
  ...
  Widget _buildDesktopTransactionRow(Map<String, dynamic> transaction, int index) {
    return Padding(
